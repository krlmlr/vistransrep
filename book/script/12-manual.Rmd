...
# unquoted col in aes()
```
```{r 12-unquoted-col-in-aes, error=TRUE}
try(
  ggplot(
  data = mpg,
  mapping = aes(
...
Another way to better display your data can be semi-transparency.
