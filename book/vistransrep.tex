...
\setlength{\droptitle}{-2em}
  ...
  \postdate{\par}
    \date{26 November 2019, 15:32 CET}
...
\NormalTok{knitr}\OperatorTok{::}\NormalTok{opts_chunk}\OperatorTok{$}\KeywordTok{set}\NormalTok{(}\DataTypeTok{fig.width =} \DecValTok{8}\NormalTok{, }\DataTypeTok{fig.height =} \DecValTok{5}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{flushright}\includegraphics{vistransrep_files/figure-latex/unnamed-chunk-33-1} \end{flushright}
...
\begin{flushright}\includegraphics{vistransrep_files/figure-latex/unnamed-chunk-34-1} \end{flushright}
...
\begin{flushright}\includegraphics{vistransrep_files/figure-latex/unnamed-chunk-40-1} \end{flushright}
...
\begin{flushright}\includegraphics{vistransrep_files/figure-latex/unnamed-chunk-40-2} \end{flushright}
...
\begin{flushright}\includegraphics{vistransrep_files/figure-latex/unnamed-chunk-42-1} \end{flushright}
...
\begin{flushright}\includegraphics{vistransrep_files/figure-latex/unnamed-chunk-43-1} \end{flushright}
...
\begin{flushright}\includegraphics{vistransrep_files/figure-latex/unnamed-chunk-44-1} \end{flushright}
...
\begin{flushright}\includegraphics{vistransrep_files/figure-latex/unnamed-chunk-45-1} \end{flushright}
...
\begin{flushright}\includegraphics{vistransrep_files/figure-latex/unnamed-chunk-46-1} \end{flushright}
...
\begin{flushright}\includegraphics{vistransrep_files/figure-latex/unnamed-chunk-47-1} \end{flushright}
...
\begin{flushright}\includegraphics{vistransrep_files/figure-latex/12-different-color-1} \end{flushright}
...
The variables used for facetting should be passed encapsulated in \texttt{vars()}.
(Before \{ggplot2\} v3.0.0 the default was to use a formula notation (\texttt{\textless{}variable\textgreater{}\ \textasciitilde{}\ \textless{}variable\textgreater{}}) to specify the facetting variables.)

\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{facet_grid}\NormalTok{(}\DataTypeTok{facets =} \KeywordTok{vars}\NormalTok{(}\OperatorTok{<}\NormalTok{variable}\OperatorTok{>}\NormalTok{), }\DataTypeTok{scales =} \StringTok{"fixed"}\NormalTok{, ...)}
\KeywordTok{facet_wrap}\NormalTok{(}\DataTypeTok{rows =} \KeywordTok{vars}\NormalTok{(}\OperatorTok{<}\NormalTok{variable}\OperatorTok{>}\NormalTok{), }\DataTypeTok{cols =} \KeywordTok{vars}\NormalTok{(}\OperatorTok{<}\NormalTok{variable}\OperatorTok{>}\NormalTok{), }
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{facet_x =}\StringTok{ }\KeywordTok{ggplot}\NormalTok{(mpg, }\KeywordTok{aes}\NormalTok{(displ, hwy)) }\OperatorTok{+}
...
\StringTok{  }\KeywordTok{facet_grid}\NormalTok{(}\KeywordTok{vars}\NormalTok{(), }\KeywordTok{vars}\NormalTok{(year)) }\OperatorTok{+}
\StringTok{  }\KeywordTok{theme_pubr}\NormalTok{()}

\NormalTok{facet_y =}\StringTok{ }\KeywordTok{ggplot}\NormalTok{(mpg, }\KeywordTok{aes}\NormalTok{(displ, hwy)) }\OperatorTok{+}
\StringTok{  }\KeywordTok{geom_point}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{colour =}\NormalTok{ fl)) }\OperatorTok{+}
\StringTok{  }\KeywordTok{scale_color_nejm}\NormalTok{() }\OperatorTok{+}
\StringTok{  }\KeywordTok{facet_grid}\NormalTok{(}\KeywordTok{vars}\NormalTok{(year), }\KeywordTok{vars}\NormalTok{()) }\OperatorTok{+}
\StringTok{  }\KeywordTok{theme_pubr}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{facet_x }\OperatorTok{+}\StringTok{ }\NormalTok{facet_y}
\end{Highlighting}
\end{Shaded}

\begin{flushright}\includegraphics{vistransrep_files/figure-latex/unnamed-chunk-4-1} \end{flushright}

Facets can also be shown on both axes using different (categorical) variables.
For this, \texttt{facet\_grid()} is useful:
...
\StringTok{  }\KeywordTok{facet_grid}\NormalTok{(}\DataTypeTok{cols =} \KeywordTok{vars}\NormalTok{(cyl), }\DataTypeTok{rows =} \KeywordTok{vars}\NormalTok{(year)) }\OperatorTok{+}
\StringTok{  }\KeywordTok{theme_pubr}\NormalTok{()}
\end{Highlighting}
\end{Shaded}

\begin{flushright}\includegraphics{vistransrep_files/figure-latex/unnamed-chunk-5-1} \end{flushright}
...
\StringTok{  }\KeywordTok{geom_point}\NormalTok{() }\OperatorTok{+}
\StringTok{  }\KeywordTok{facet_wrap}\NormalTok{(}\KeywordTok{vars}\NormalTok{(manufacturer}\OperatorTok{:}\NormalTok{year)) }\OperatorTok{+}
\StringTok{  }\KeywordTok{theme_pubr}\NormalTok{()}
\end{Highlighting}
\end{Shaded}

\begin{flushright}\includegraphics{vistransrep_files/figure-latex/unnamed-chunk-6-1} \end{flushright}
...
\KeywordTok{ggplot}\NormalTok{(mpg, }\KeywordTok{aes}\NormalTok{(displ, hwy)) }\OperatorTok{+}
\StringTok{  }\KeywordTok{geom_point}\NormalTok{() }\OperatorTok{+}
\StringTok{  }\KeywordTok{facet_wrap}\NormalTok{(}\KeywordTok{vars}\NormalTok{(manufacturer, year)) }\OperatorTok{+}
\StringTok{  }\KeywordTok{theme_pubr}\NormalTok{()}
\end{Highlighting}
\end{Shaded}

\begin{flushright}\includegraphics{vistransrep_files/figure-latex/unnamed-chunk-7-1} \end{flushright}

\hypertarget{facet_grid}{%
\subsection{\texorpdfstring{\texttt{facet\_grid()}}{facet\_grid()}}\label{facet_grid}}

While \texttt{facet\_wrap()} tries to act smart and share axes of sub-plots, \texttt{facet\_grid()} will create a grid of sub-plots each having their own axes.
...
\begin{itemize}
\item
  when facetting over \textgreater{}= 2 variables
\item
  when plots of empty combinations should be shown
\end{itemize}

Let's compare how \texttt{facet\_grid} and \texttt{facet\_wrap} differ for 2 grouping variables

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{fc_gd =}\StringTok{ }\KeywordTok{ggplot}\NormalTok{(mpg, }\KeywordTok{aes}\NormalTok{(displ, hwy)) }\OperatorTok{+}
\StringTok{  }\KeywordTok{geom_point}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{colour =}\NormalTok{ class)) }\OperatorTok{+}
\StringTok{  }\KeywordTok{facet_grid}\NormalTok{(}\KeywordTok{vars}\NormalTok{(year), }\KeywordTok{vars}\NormalTok{(cyl)) }\OperatorTok{+}
\StringTok{  }\KeywordTok{theme_pubr}\NormalTok{()}

\NormalTok{fc_wrap =}\StringTok{ }\KeywordTok{ggplot}\NormalTok{(mpg, }\KeywordTok{aes}\NormalTok{(displ, hwy)) }\OperatorTok{+}
\StringTok{  }\KeywordTok{geom_point}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{colour =}\NormalTok{ class)) }\OperatorTok{+}
\StringTok{  }\KeywordTok{facet_wrap}\NormalTok{(}\KeywordTok{vars}\NormalTok{(year, cyl)) }\OperatorTok{+}
\StringTok{  }\KeywordTok{theme_pubr}\NormalTok{()}

\NormalTok{fc_gd }\OperatorTok{/}\StringTok{ }\NormalTok{fc_wrap}
\end{Highlighting}
\end{Shaded}

\begin{flushright}\includegraphics{vistransrep_files/figure-latex/unnamed-chunk-8-1} \end{flushright}
...
\begin{flushright}\includegraphics{vistransrep_files/figure-latex/unnamed-chunk-9-1} \end{flushright}
...
\KeywordTok{ggplot}\NormalTok{(mpg, }\KeywordTok{aes}\NormalTok{(displ, hwy)) }\OperatorTok{+}
\StringTok{  }\KeywordTok{geom_point}\NormalTok{() }\OperatorTok{+}
\StringTok{  }\KeywordTok{facet_grid}\NormalTok{(}\KeywordTok{vars}\NormalTok{(), }\KeywordTok{vars}\NormalTok{(cyl), }\DataTypeTok{labeller =}\NormalTok{ label_both) }\OperatorTok{+}
\StringTok{  }\KeywordTok{theme_pubr}\NormalTok{()}
\end{Highlighting}
\end{Shaded}

\begin{flushright}\includegraphics{vistransrep_files/figure-latex/unnamed-chunk-10-1} \end{flushright}
...
\begin{flushright}\includegraphics{vistransrep_files/figure-latex/unnamed-chunk-11-1} \end{flushright}
