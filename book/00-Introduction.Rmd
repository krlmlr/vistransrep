...
```{r, echo=FALSE, fig.cap="RStudio dashboard metapher ^[Source: [Modern Dive](https://moderndive.com/)]" }
...
```{r, echo=FALSE, fig.cap="R phone metapher ^[Source: [Modern Dive](https://moderndive.com/)]" }
