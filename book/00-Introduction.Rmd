...
knitr::include_graphics("images/pjs.jpg", dpi = 180)
```
...
```{R 00-Introduction-3, indeeddotcom, echo = F, fig.height = 6, fig.width = 9}
# The popularity data
pop_df <-
  data.frame(
