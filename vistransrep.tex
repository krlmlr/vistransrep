...
\date{29 November 2019, 13:55 CET}
...
\begin{flushright}\includegraphics{vistransrep_files/figure-latex/101-empty-graph-1} \end{flushright}
...
\begin{flushright}\includegraphics{vistransrep_files/figure-latex/101-visualize-variables-as-points-scatterplot-1} \end{flushright}
...
\begin{flushright}\includegraphics{vistransrep_files/figure-latex/101-aes-determines-which-variables-are-plotted-1} \end{flushright}
...
\begin{flushright}\includegraphics{vistransrep_files/figure-latex/101-pattern-unchanged-if-only-variables-are-plotted-1} \end{flushright}
...
\begin{flushright}\includegraphics{vistransrep_files/figure-latex/12-show-geom-boxplot-1} \end{flushright}
...
\begin{flushright}\includegraphics{vistransrep_files/figure-latex/12-combining-multiple-geoms-1} \end{flushright}
...
\begin{flushright}\includegraphics{vistransrep_files/figure-latex/13-continuous-x-and-y-1} \end{flushright}
...
\begin{flushright}\includegraphics{vistransrep_files/figure-latex/13-discrete-x-and-continuous-y-1} \end{flushright}
...
\begin{flushright}\includegraphics{vistransrep_files/figure-latex/13-discrete-x-and-y-1} \end{flushright}
...
\begin{flushright}\includegraphics{vistransrep_files/figure-latex/14-continuous-variables-histogram-most-common-1} \end{flushright}
...
\begin{flushright}\includegraphics{vistransrep_files/figure-latex/14-showcase-density-1} \end{flushright}
...
\begin{flushright}\includegraphics{vistransrep_files/figure-latex/14-example-for-discrete-var-barplot-1} \end{flushright}
...
\begin{flushright}\includegraphics{vistransrep_files/figure-latex/105-static-color-blue-1} \end{flushright}
...
\begin{flushright}\includegraphics{vistransrep_files/figure-latex/105-dynamic-color-variable-mapping-discrete-1} \end{flushright}
...
\begin{flushright}\includegraphics{vistransrep_files/figure-latex/105-dynamic-color-variable-mapping-cont-1} \end{flushright}
...
\begin{flushright}\includegraphics{vistransrep_files/figure-latex/105-shape-1} \end{flushright}
...
\begin{flushright}\includegraphics{vistransrep_files/figure-latex/105-dynamic-combining-color-and-shape-1} \end{flushright}
...
\begin{flushright}\includegraphics{vistransrep_files/figure-latex/105-dynamic-size-1} \end{flushright}
...
\begin{flushright}\includegraphics{vistransrep_files/figure-latex/105-sometimes-less-is-more-1} \end{flushright}
...
\begin{flushright}\includegraphics{vistransrep_files/figure-latex/105-transparency-alpha-1} \end{flushright}
...
\begin{flushright}\includegraphics{vistransrep_files/figure-latex/105-what-can-go-wrong-1} \end{flushright}
...
\begin{flushright}\includegraphics{vistransrep_files/figure-latex/105-what-happens-with-strings-in-aes-1} \end{flushright}
...
\begin{flushright}\includegraphics{vistransrep_files/figure-latex/105-map-static-colors-outside-of-aes-1} \end{flushright}
...
\begin{flushright}\includegraphics{vistransrep_files/figure-latex/16-showcase-geom-text-1} \end{flushright}
...
\begin{flushright}\includegraphics{vistransrep_files/figure-latex/16-object-vs-string-again-1} \end{flushright}
...
\begin{flushright}\includegraphics{vistransrep_files/figure-latex/16-dynamic-labeling-to-variable-1} \end{flushright}
...
\begin{flushright}\includegraphics{vistransrep_files/figure-latex/unnamed-chunk-100-2} \end{flushright}
...
\begin{flushright}\includegraphics{vistransrep_files/figure-latex/unnamed-chunk-102-1} \end{flushright}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{plot_ly}\NormalTok{(}\DataTypeTok{z =} \OperatorTok{~}\NormalTok{volcano, }\DataTypeTok{type =} \StringTok{"surface"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{flushright}\includegraphics{vistransrep_files/figure-latex/unnamed-chunk-106-1} \end{flushright}
...
\NormalTok{month }\OperatorTok{%in%}\StringTok{ }\KeywordTok{c}\NormalTok{(}\DecValTok{12}\NormalTok{, }\DecValTok{1}\NormalTok{, }\DecValTok{2}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
\item
  Negation: \texttt{!}
  ...
  \tightlist
  \item
    Use parentheses \texttt{()} to indicate precedence
  \end{itemize}
\item
...
\hfill{}\includegraphics[width=11.11in]{img/group_by_ungroup} 

\caption{© Allison Horst}\label{fig:group-by-pic}
\end{figure}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{set.seed}\NormalTok{(}\DecValTok{20191129}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
The \texttt{airlines} data contains details (really just the name) of airlines, by carrier code.
...
Only the carrier code is available in the \texttt{flights} dataset.
The airline name can be brought in with the \texttt{left\_join()} function, e.g., to use in a pretty label.
...
\StringTok{  }\KeywordTok{select}\NormalTok{(dep_time, carrier, name)}
\end{Highlighting}
\end{Shaded}
...
** Your turn**: Bring in data from the \texttt{planes} table.
What happens if you omit the \texttt{by} argument?
...
\KeywordTok{try}\NormalTok{(}
\NormalTok{  ... }\OperatorTok{%>%}
\StringTok{    }\KeywordTok{..._join}\NormalTok{(...)}
\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\KeywordTok{try}\NormalTok{(}
\NormalTok{  ... }\OperatorTok{%>%}
\StringTok{    }\KeywordTok{..._join}\NormalTok{(..., }\DataTypeTok{... =} \StringTok{"..."}\NormalTok{)}
\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
The \texttt{airports} table does not have any columns common to \texttt{flights}.
...
\KeywordTok{try}\NormalTok{(}
\NormalTok{  flights }\OperatorTok{%>%}
\StringTok{    }\KeywordTok{left_join}\NormalTok{(airports)}
\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
A \texttt{by} argument with a specific syntax is required here.
...
\StringTok{  }\KeywordTok{select}\NormalTok{(origin, dest, name)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{flights }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{left_join}\NormalTok{(airports, }\DataTypeTok{by =} \KeywordTok{c}\NormalTok{(}\StringTok{"dest"}\NormalTok{ =}\StringTok{ "faa"}\NormalTok{)) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{select}\NormalTok{(origin, dest, name) }\OperatorTok{%>%}
...
The \texttt{airports} table does not contain a row for the BQN airport.

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{airports }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{filter}\NormalTok{(faa }\OperatorTok{==}\StringTok{ "BQN"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
The \texttt{inner\_join()} discards rows with mismatches.
...
\textbf{Your turn}: Why are some rows with the \texttt{planes} table not matched?

\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{try}\NormalTok{(}
\NormalTok{  ... }\OperatorTok{%>%}
\StringTok{    }\KeywordTok{left_join}\NormalTok{(..., }\DataTypeTok{... =} \StringTok{"..."}\NormalTok{) }\OperatorTok{%>%}
\StringTok{    }\KeywordTok{filter}\NormalTok{(}\KeywordTok{is.na}\NormalTok{(...))}
\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{  ... }\OperatorTok{%>%}
\StringTok{    }\KeywordTok{left_join}\NormalTok{(..., }\DataTypeTok{... =} \StringTok{"..."}\NormalTok{) }\OperatorTok{%>%}
\StringTok{    }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{mismatch =} \KeywordTok{is.na}\NormalTok{(...), }\DataTypeTok{is_aa =}\NormalTok{ (carrier }\OperatorTok{==}\StringTok{ "AA"}\NormalTok{)) }\OperatorTok{%>%}
...
The following example uses \texttt{rpart::rpart()} to classify missingness by the other columns.
Turns out there is a pattern, which needs to be investigated further in the original data.

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{flights }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{left_join}\NormalTok{(planes }\OperatorTok{%>%}\StringTok{ }\KeywordTok{select}\NormalTok{(tailnum, manufacturer), }\DataTypeTok{by =} \StringTok{"tailnum"}\NormalTok{) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{mismatch =} \KeywordTok{is.na}\NormalTok{(manufacturer)) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{select}\NormalTok{(}\OperatorTok{-}\NormalTok{tailnum, }\OperatorTok{-}\NormalTok{manufacturer) }\OperatorTok{%>%}
\StringTok{  }\NormalTok{rpart}\OperatorTok{::}\KeywordTok{rpart}\NormalTok{(mismatch }\OperatorTok{~}\StringTok{ }\NormalTok{., .)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{origin_airports <-}
\StringTok{  }\NormalTok{airports }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{select}\NormalTok{(}\DataTypeTok{origin =}\NormalTok{ faa, }\DataTypeTok{origin_name =}\NormalTok{ name)}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{dest_airports <-}
\StringTok{  }\NormalTok{airports }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{select}\NormalTok{(}\DataTypeTok{dest =}\NormalTok{ faa, }\DataTypeTok{dest_name =}\NormalTok{ name)}
...
\begin{Highlighting}[]
\NormalTok{flights }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{left_join}\NormalTok{(origin_airports) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{left_join}\NormalTok{(dest_airports) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{select}\NormalTok{(origin, origin_name, dest, dest_name)}
\end{Highlighting}
\end{Shaded}
...
Still, it is recommended to explicitly specify the \texttt{by} column.

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{flights }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{left_join}\NormalTok{(origin_airports, }\DataTypeTok{by =} \StringTok{"origin"}\NormalTok{) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{left_join}\NormalTok{(dest_airports, }\DataTypeTok{by =} \StringTok{"dest"}\NormalTok{) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{select}\NormalTok{(origin, origin_name, dest, dest_name)}
\end{Highlighting}
\end{Shaded}
...
\textbf{Your turn}: How do we bring in only the \texttt{engines} and \texttt{seats} columns from the \texttt{planes} table?

\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{try}\NormalTok{(\{}
\NormalTok{  planes_join <-}
\StringTok{    }\NormalTok{... }\OperatorTok{%>%}
\StringTok{    }\KeywordTok{...}\NormalTok{(...)}

\NormalTok{  ... }\OperatorTok{%>%}
\StringTok{    }\KeywordTok{left_join}\NormalTok{(..., }\DataTypeTok{... =} \StringTok{"..."}\NormalTok{)}
\NormalTok{\})}
\end{Highlighting}
\end{Shaded}
...
For the join to work as expected, it is important that the columns in \texttt{by} uniquely define observations, either in the left-hand-side or in the right-hand-side table, or in both.
If this is given, the column or columns are a \emph{primary key} to the table.
The \texttt{count()} function helps asserting this.

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{airports }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{count}\NormalTok{(faa)}
\end{Highlighting}
\end{Shaded}
...
\textbf{Your turn}: Double-check that \texttt{tailnum} is indeed a key to \texttt{planes}.
...
In the example below we derive a dataset from \texttt{airports} that intentionally has duplicate observations.
The \texttt{faa} column is no longer a key to the table.

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{dup_airports <-}
\StringTok{  }\KeywordTok{bind_rows}\NormalTok{(airports, }\KeywordTok{sample_n}\NormalTok{(airports, }\DecValTok{100}\NormalTok{))}

\NormalTok{dup_airports }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{count}\NormalTok{(faa)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{dup_airports }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{count}\NormalTok{(faa) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{add_count}\NormalTok{(n) }\OperatorTok{%>%}
...
Because we have duplicate observations with the same value in the \texttt{faa} column (and of course we have many more flights), the join will produce duplicate flights.
This is almost always undesirable!

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{flights }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{left_join}\NormalTok{(dup_airports, }\DataTypeTok{by =} \KeywordTok{c}\NormalTok{(}\StringTok{"dest"}\NormalTok{ =}\StringTok{ "faa"}\NormalTok{)) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{select}\NormalTok{(origin, dest, name)}
\end{Highlighting}
\end{Shaded}
...
\textbf{Your turn}: Find a key to the \texttt{weather} table.
...
\StringTok{  }\KeywordTok{count}\NormalTok{(origin, year, month, day, hour) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{count}\NormalTok{(n)}
\end{Highlighting}
\end{Shaded}
...
The \href{https://krlmlr.github.io/dm/}{\{dm\} package} is a modern take on handling multiple tables in your R session.
A \texttt{dm} object combines the data and metadata for tables, and the relationships between these tables.
Joins no longer require specification of the \texttt{by} columns.
...
\textbf{Your turn}: The result of this operation isn't strictly equivalent to \texttt{table2}.
What is missing?
...
\textbf{Your turn}: \texttt{pivot\_wider()} expects columns \texttt{name} and \texttt{value} by default.
What do we need to do to get rid of \texttt{names\_from} and \texttt{values\_from}?
...
\begin{flushright}\includegraphics{vistransrep_files/figure-latex/401-longer-form-more-useful-for-plotting-all-values-side-by-side-1} \end{flushright}
...
\begin{flushright}\includegraphics{vistransrep_files/figure-latex/401-longer-form-more-useful-for-plotting-all-values-side-by-side-2} \end{flushright}
...
\begin{flushright}\includegraphics{vistransrep_files/figure-latex/401-wider-form-more-useful-for-plotting-a-single-value-1} \end{flushright}
...
\begin{flushright}\includegraphics{vistransrep_files/figure-latex/401-wider-form-more-useful-for-plotting-a-single-value-2} \end{flushright}
...
\begin{flushright}\includegraphics{vistransrep_files/figure-latex/401-wider-form-the-only-way-to-correlate-values-1} \end{flushright}
...
\textbf{Your turn}: As before, \texttt{pivot\_longer()} helps converting the results into something similar to \texttt{table2}.
...
\StringTok{    }\KeywordTok{...}\NormalTok{(}\KeywordTok{c}\NormalTok{(.....))}
\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\begin{verbatim}
## Error in ...(., c(.....)) : could not find function "..."
\end{verbatim}
...
\hypertarget{the-anscombe-dataset}{%
\subsection{The Anscombe dataset}\label{the-anscombe-dataset}}
...
\StringTok{  }\KeywordTok{summarize_all}\NormalTok{(}\KeywordTok{list}\NormalTok{(}\OperatorTok{~}\StringTok{ }\KeywordTok{mean}\NormalTok{(.), }\OperatorTok{~}\StringTok{ }\KeywordTok{sd}\NormalTok{(.)))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{lm}\NormalTok{(y1 }\OperatorTok{~}\StringTok{ }\NormalTok{x1, anscombe)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{lm}\NormalTok{(y2 }\OperatorTok{~}\StringTok{ }\NormalTok{x2, anscombe)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{lm}\NormalTok{(y3 }\OperatorTok{~}\StringTok{ }\NormalTok{x3, anscombe)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{lm}\NormalTok{(y4 }\OperatorTok{~}\StringTok{ }\NormalTok{x4, anscombe)}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\KeywordTok{try}\NormalTok{(}
  \KeywordTok{ggplot}\NormalTok{(anscombe) }\OperatorTok{+}\StringTok{ }
\StringTok{    }\NormalTok{...}
\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{verbatim}
## Error in try(ggplot(anscombe) + ...) : '...' used in an incorrect context
\end{verbatim}

\textbf{Your turn}: Which principles of tidy data does the \texttt{anscombe} dataset violate?

Many operations become much more natural when the data is in longer form.

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{anscombe_longer <-}
\StringTok{  }\NormalTok{anscombe }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{id =} \KeywordTok{row_number}\NormalTok{()) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{pivot_longer}\NormalTok{(}
    \OperatorTok{-}\NormalTok{id,}
    \DataTypeTok{names_pattern =} \StringTok{"(.)(.)"}\NormalTok{,}
    \DataTypeTok{names_to =} \KeywordTok{c}\NormalTok{(}\StringTok{".value"}\NormalTok{, }\StringTok{"measurement"}\NormalTok{)}
\NormalTok{  ) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{arrange}\NormalTok{(measurement, id)}

\NormalTok{anscombe_longer }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{group_by}\NormalTok{(measurement) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{summarize_at}\NormalTok{(}\KeywordTok{vars}\NormalTok{(x, y), }\KeywordTok{list}\NormalTok{(}\OperatorTok{~}\StringTok{ }\KeywordTok{mean}\NormalTok{(.), }\OperatorTok{~}\KeywordTok{sd}\NormalTok{(.))) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{ungroup}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{anscombe_longer }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{group_by}\NormalTok{(measurement) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{summarize}\NormalTok{(}\DataTypeTok{model =} \KeywordTok{list}\NormalTok{(}\KeywordTok{lm}\NormalTok{(y }\OperatorTok{~}\StringTok{ }\NormalTok{x, .))) }\OperatorTok{%>%}
...
\StringTok{  }\KeywordTok{geom_point}\NormalTok{() }\OperatorTok{+}
\StringTok{  }\KeywordTok{facet_wrap}\NormalTok{(}\KeywordTok{vars}\NormalTok{(measurement))}
\end{Highlighting}
\end{Shaded}

\begin{flushright}\includegraphics{vistransrep_files/figure-latex/401-easier-to-work-with-in-longer-form-1} \end{flushright}

\hypertarget{who-data}{%
\subsection{WHO data}\label{who-data}}
...
\hypertarget{formatting-tables-for-presentation}{%
\subsection{Formatting tables for presentation}\label{formatting-tables-for-presentation}}
...
For this, \texttt{ftable()} is the better tool.
...
These can be converted to HTML for inclusion in reports, e.g.~with \texttt{memisc::format\_html()}.

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{table2_html <-}
\StringTok{  }\NormalTok{table2 }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{xtabs}\NormalTok{(count }\OperatorTok{~}\StringTok{ }\NormalTok{., .) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{ftable}\NormalTok{(}\DataTypeTok{col.vars =} \KeywordTok{c}\NormalTok{(}\StringTok{"year"}\NormalTok{, }\StringTok{"type"}\NormalTok{)) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\NormalTok{memisc}\OperatorTok{::}\KeywordTok{format_html}\NormalTok{()}

\KeywordTok{cat}\NormalTok{(table2_html)}
\end{Highlighting}
\end{Shaded}

The \href{https://gt.rstudio.com/}{\{gt\} package} is a modern approach to present tables for formatting.
...
The \texttt{table3} table violates the third principle of tidy data: each cell in the \texttt{rate} column contains two values.
...
\FunctionTok{date:}\AttributeTok{ }\StringTok{"2019-11-29"}
\FunctionTok{output:}
...
\item
  \href{https://github.com/rstudio/blogdown}{blogdown}: For creating websites. Example: \url{https://pat-s.me}
\item
