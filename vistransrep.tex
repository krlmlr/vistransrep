...
\date{27 November 2019, 16:29 CET}
...
\begin{flushright}\includegraphics{vistransrep_files/figure-latex/unnamed-chunk-31-1} \end{flushright}
...
\begin{flushright}\includegraphics{vistransrep_files/figure-latex/unnamed-chunk-32-1} \end{flushright}
...
\begin{flushright}\includegraphics{vistransrep_files/figure-latex/unnamed-chunk-35-1} \end{flushright}
...
\begin{flushright}\includegraphics{vistransrep_files/figure-latex/unnamed-chunk-36-1} \end{flushright}
...
\begin{flushright}\includegraphics{vistransrep_files/figure-latex/unnamed-chunk-37-1} \end{flushright}
...
\begin{flushright}\includegraphics{vistransrep_files/figure-latex/unnamed-chunk-38-1} \end{flushright}

\hypertarget{exercises}{%
\section{Exercises}\label{exercises}}

\url{https://krlmlr.github.io/vistransrep/2019-11-zhr/scatter.html}
...
\begin{flushright}\includegraphics{vistransrep_files/figure-latex/18-base-plot-1} \end{flushright}
...
\begin{flushright}\includegraphics{vistransrep_files/figure-latex/18-bw-theme-1} \end{flushright}
...
\begin{flushright}\includegraphics{vistransrep_files/figure-latex/18-data-can-have-color-in-bw-theme-1} \end{flushright}
...
\begin{flushright}\includegraphics{vistransrep_files/figure-latex/18-occasionally-useful-legend-at-the-bottom-1} \end{flushright}
...
\begin{flushright}\includegraphics{vistransrep_files/figure-latex/18-theme-functions-overwrite-theme-if-called-afterwards-1} \end{flushright}
...
\begin{flushright}\includegraphics{vistransrep_files/figure-latex/18-first-param-of-theme-functions-is-base-size-1} \end{flushright}
...
\begin{flushright}\includegraphics{vistransrep_files/figure-latex/18-ggpubr-1} \end{flushright}
...
\begin{flushright}\includegraphics{vistransrep_files/figure-latex/19-base-plot-1} \end{flushright}
...
\begin{flushright}\includegraphics{vistransrep_files/figure-latex/19-add-descriptive-labels-the-labs-function-1} \end{flushright}
...
\begin{flushright}\includegraphics{vistransrep_files/figure-latex/19-change-scale-to-log-scale-1} \end{flushright}
...
\begin{flushright}\includegraphics{vistransrep_files/figure-latex/19-name-in-scale-overwrites-labs-without-warning-1} \end{flushright}
...
\begin{flushright}\includegraphics{vistransrep_files/figure-latex/19-custom-axis-breaks-1} \end{flushright}
...
\begin{flushright}\includegraphics{vistransrep_files/figure-latex/19-default-1} \end{flushright}
...
\begin{flushright}\includegraphics{vistransrep_files/figure-latex/19-other-options-viridis-1} \end{flushright}
...
\begin{flushright}\includegraphics{vistransrep_files/figure-latex/19-full-control-manual-scale-1} \end{flushright}
...
\begin{flushright}\includegraphics{vistransrep_files/figure-latex/unnamed-chunk-44-2} \end{flushright}
...
\begin{flushright}\includegraphics[width=0.5\linewidth]{vistransrep_files/figure-latex/facet-wrap1-1} \includegraphics[width=0.5\linewidth]{vistransrep_files/figure-latex/facet-wrap1-2} \end{flushright}
...
\begin{flushright}\includegraphics[width=0.5\linewidth]{vistransrep_files/figure-latex/unnamed-chunk-3-1} \includegraphics[width=0.5\linewidth]{vistransrep_files/figure-latex/unnamed-chunk-3-2} \end{flushright}
