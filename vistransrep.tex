...
\date{27 November 2019, 20:35 CET}
...
\begin{flushright}\includegraphics[width=9.33in]{img/kirill} \end{flushright}
...
\begin{flushright}\includegraphics{vistransrep_files/figure-latex/11-visualize-variables-as-points-scatterplot-1} \end{flushright}
...
\begin{flushright}\includegraphics{vistransrep_files/figure-latex/15-static-color-blue-1} \end{flushright}
...
\begin{flushright}\includegraphics{vistransrep_files/figure-latex/15-dynamic-color-variable-mapping-discrete-1} \end{flushright}
...
\begin{flushright}\includegraphics{vistransrep_files/figure-latex/15-dynamic-color-variable-mapping-cont-1} \end{flushright}
...
\begin{flushright}\includegraphics{vistransrep_files/figure-latex/15-shape-1} \end{flushright}
...
\begin{flushright}\includegraphics{vistransrep_files/figure-latex/15-dynamic-combining-color-and-shape-1} \end{flushright}
...
\begin{flushright}\includegraphics{vistransrep_files/figure-latex/15-dynamic-size-1} \end{flushright}
...
\begin{flushright}\includegraphics{vistransrep_files/figure-latex/15-sometimes-less-is-more-1} \end{flushright}
...
\begin{flushright}\includegraphics{vistransrep_files/figure-latex/15-transparency-alpha-1} \end{flushright}
...
\begin{flushright}\includegraphics{vistransrep_files/figure-latex/15-what-can-go-wrong-1} \end{flushright}
...
\begin{flushright}\includegraphics{vistransrep_files/figure-latex/15-what-happens-with-strings-in-aes-1} \end{flushright}
...
\begin{flushright}\includegraphics{vistransrep_files/figure-latex/15-map-static-colors-outside-of-aes-1} \end{flushright}
...
\begin{flushright}\includegraphics{vistransrep_files/figure-latex/18-base-plot-to-start-with-1} \end{flushright}
...
\begin{flushright}\includegraphics{vistransrep_files/figure-latex/18-add-descriptive-labels-the-labs-function-1} \end{flushright}
...
\begin{flushright}\includegraphics{vistransrep_files/figure-latex/18-change-scale-to-log-scale-1} \end{flushright}
...
\begin{flushright}\includegraphics{vistransrep_files/figure-latex/18-name-in-scale-overwrites-labs-without-warning-1} \end{flushright}
...
\begin{flushright}\includegraphics{vistransrep_files/figure-latex/18-showcase-manual-axis-scaling-limits-breaks-labels-1} \end{flushright}
...
\begin{flushright}\includegraphics{vistransrep_files/figure-latex/18-default-color-palette-1} \end{flushright}
...
\begin{flushright}\includegraphics{vistransrep_files/figure-latex/18-show-viridis-color-palette-discrete-1} \end{flushright}
...
\begin{flushright}\includegraphics{vistransrep_files/figure-latex/18-show-how-to-set-manual-colors-1} \end{flushright}
...
\begin{flushright}\includegraphics{vistransrep_files/figure-latex/unnamed-chunk-4-2} \end{flushright}
